    ...
    render(){
        return(
            <div className="login">
                ...
                <div className="buttbox">
                <button onClick={this.move} className="googlebutt"><img src="https://www.freepnglogos.com/uploads/google-logo-png/google-logo-png-webinar-optimizing-for-success-google-business-webinar-13.png" width="22px" height="22px" />Sign In with Google</button>
                </div>
